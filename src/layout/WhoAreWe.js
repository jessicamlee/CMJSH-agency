...
export default function Intro() {
  return (
    <div className='grid grid-cols-1 px-6 mt-52 relative mb-20 md:mt-[21rem] lg:grid-cols-2 lg:mt-56 xl:mt-40 xl:mb-64 xl:max-w-screen-xl xl:mx-auto'>
        <img className='absolute w-[21.5rem] -top-[17rem] right-0 left-0 mx-auto md:w-[42rem] md:-top-[29.3rem] lg:max-w-none lg:w-[84rem] lg:-top-[27.5rem] lg:-right-[63rem] xl:w-[86rem] xl:-top-[22rem] xl:-right-[58rem]' src='assets/images/cmjshfull.png' alt='our work'></img>
